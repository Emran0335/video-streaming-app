        ...
        <div className="w-full max-w-sm text-center mt-6">
          ...
          {!videos && (
            <button
              ...
              className="mt-4 inline-flex items-center gap-x-2 bg-pink-50 hover:bg-pink-500/90 bordeer border-transparent rounded-lg hover:border-white px-3 py-1.5 font-semibold text-black"
            >
    ...
    return (
      <div className="flex justify-center p-4">
        <div className="w-full max-w-sm text-center mt-6">
          ...
          <h5>{videos ? "Empty playlist" : "No playlist created"}</h5>
          <p>
            {videos
              ? "This playlist has no videos"
              : "There is no playlist created on this channel"}
          </p>
        </div>
      </div>
    );
