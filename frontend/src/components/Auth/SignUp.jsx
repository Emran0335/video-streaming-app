    ...
    <div className="h-screen w-full overflow-y-auto bg-[#121212] text-white">
      <div className="mx-auto my-10 flex w-full max-w-sm flex-col px-4">
        ...
        <form
          ...
          className="mx-auto mt-2 flex flex-col max-w-sm px-4 border p-4 border-gray-700"
        >
          <Input
            label="Full Name"
            required
            ...
            {...register("avatar", {
              ...
              validate: (file) => {
                ...
                return allowedExtensions.includes(fileType)
                  ? true
                  : "Invalid file type! Only .png .jpg and .jpeg file is accepted";
              },
            })}
          />
          {errors.avatar && (
          ...
          <Input
            ...
            {...register("coverImage", {
              ...
              validate: (file) => {
                ...
                return allowedExtensions.includes(fileType)
                  ? true
                  : "Invalid file type! Only .png, .jpeg and .jpg file is accepted";
              },
            })}
          />
          {errors.coverImage && (
