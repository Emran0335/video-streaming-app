      ...
      {showPopup &&
        createPortal(
          <dialog
            ref={dialog}
            onClose={handleClose}
            className="mx-auto w-[90%] backdrop:backdrop-blur-sm sm:w-[60%] lg:w-[40%] xl:w-[30%] overflow-auto bg-gray-900/80 text-white rounded-xl border border-gray-600"
          >
            <div className="mx-8 my-6 mb-8 flex flex-col relative">
              ...
              <h6 className="mx-auto text-sm mb-3">
