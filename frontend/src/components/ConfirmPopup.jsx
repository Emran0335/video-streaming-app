    ...
    <div className="absolute">
      {showPopup &&
        createPortal(
          ...
          >
            <div className="relative flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82)]">
              <div className="fixed inset-0 top-[calc(66px)] z-10 flex flex-col bg-black/50 px-4 sm:top-[calc(82px)] sm:px-14 sm:py-8">
                <form
