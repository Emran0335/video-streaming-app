      ...
      <ul className="px-2 py-2">
        {authStatus && (
          <li
            ...
            className={`ml-1 hover:bg-gray-800 transition-all duration-100 cursor-pointer flex items-center rounded-lg ${
              isWatchPage ? "justify-center" : "px-5"
            }`}
          >
        ...
        {authStatus && (
          ...
          >
            <li
              className={`flex items-center hover:bg-gray-800 transition-all duration-100 cursor-pointer rounded-lg py-2 ${
                isWatchPage ? "justify-center" : "px-5"
              }`}
            >
              <span className={`${isWatchPage ? "" : "mr-2"}`}>
