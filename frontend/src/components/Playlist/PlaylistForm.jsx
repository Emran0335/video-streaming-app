...
function PlaylistForm({ playlist, route }, ref) {
  ...
  return (
    <div className="absolute shadow-sm border-red-700">
      {showPopup &&
        createPortal(
          <dialog
            ref={dialog}
            ...
            <div className="relative flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
              <div className="fixed inset-0 top-[calc(66px)] z-10 flex flex-col px-4 pb-[86px] pt-4 sm:top-[calc(82px)] sm:px-14 sm:py-8">
                <form
                  ...
                  className="mx-auto w-full max-w-lg overflow-auto rounded-lg border-gray-700 text-white bg-zinc-950 p-4"
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Button
                      type="submit"
                      disabled={loading}
                      className="mt-6 py-2 rounded-lg disabled:cursor-not-allowed"
