...
import streamify_cover from "../assets/logo.png";
...
function Settings() {
  ...
  const uploadAvatar = async (data) => {
    ...
    try {
      ...
      if (response.data?.data?.coverImage) {
        dispatch(setUser({ ...userData, avatar: response.data.data.avatar }));
    ...
    <section className="w-full">
      <div className="relative min-h-[150px] w-full pt-[20%]">
        ...
        >
          ...
          />
          {errors.coverImage && toast.error(errors.coverImage.message)}
          <label
            htmlFor="cover-image"
        ...
        <div className="flex flex-wrap gap-4 pb-4 pt-6">
          <div className="relative -mt-12 inline-block h-32 w-32 shrink-0 overflow-hidden rounded-full border-2">
            ...
            >
              ...
              />
              {errors2.avatar && toast.error(errors2.avatar.message)}
              <label
